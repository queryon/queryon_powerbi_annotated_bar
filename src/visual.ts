...
export interface AnnotatedBarDataPoint {
  colName: string;
  colVal: string;
  value: any;
  displayName: string;
...
export interface AnnotatedBarViewModel {
...
public enumerateObjectInstances(options: EnumerateVisualObjectInstancesOptions): VisualObjectInstanceEnumeration 
{
  ...
  switch (objectName) 
  {
    case 'annotationSettings':
      this.annotationSettingsUpdateWhenFormatIsChanged(objectName, dataPoints, objectEnumeration);
      break;

    case 'textFormatting':
      this.textFormattingUpdateWhenFormatIsChanged(objectName, dataPoints, objectEnumeration);
      break;

    case 'axisSettings':
      this.axisSettingsUpdateWhenFormatIsChanged(objectName, dataPoints, objectEnumeration);
      break;
