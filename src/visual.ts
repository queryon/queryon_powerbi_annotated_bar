...
export class Visual implements IVisual {
  ...
  public enumerateAnnotationSettings(objectEnumeration: VisualObjectInstance[], objectName: string)
  {
  ...
  public enumeratetextFormattingSettings(objectEnumeration: VisualObjectInstance[], objectName: string, dataPoints: AnnotatedBarDataPoint[])
  {
    objectEnumeration.push({
      objectName: objectName,
  ...
  public enumerateAxisSettings(objectEnumeration: VisualObjectInstance[], objectName: string)
  {
    objectEnumeration.push({
      objectName: objectName, properties: {
  ...
  public enumerateBarColorSelectorSettings(objectEnumeration: VisualObjectInstance[], objectName: string, dataPoints: AnnotatedBarDataPoint[])
  {
    objectEnumeration.push({
      objectName: objectName,
      properties: {
  ...
  public enumerateObjectInstances(options: EnumerateVisualObjectInstancesOptions): VisualObjectInstanceEnumeration {
    ...
    switch (objectName) {
      case 'annotationSettings':
        ...
        break
      case 'textFormatting':
        this.enumeratetextFormattingSettings(objectEnumeration, objectName, dataPoints)
        break;
      case 'axisSettings':
        this.enumerateAxisSettings(objectEnumeration, objectName)
        break
      case 'barColorSelector':
       this.enumerateBarColorSelectorSettings(objectEnumeration, objectName, dataPoints)
        break;
    };
